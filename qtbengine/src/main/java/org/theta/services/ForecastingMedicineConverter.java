...
public class ForecastingMedicineConverter {
     ...
     */
    public static byte[] convertToXmlBytes(List<ForecastingMedicine> medicines, List<ForecastingRegimen> regimes) throws JAXBException {
