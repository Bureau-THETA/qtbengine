...
public class ForecastingTotalItemUIAdapter extends AbstractUIAdapter {
	...
	public String getCalculationMethod(){
		String res = Messages.getString("ForecastingDocumentWindow.tbSummary.byPercents");
		if(getFcItemObj().isIsValue()){
			res = Messages.getString("ForecastingDocumentWindow.tbSummary.byValue");
		}
		return res;
	}
	/**
	...
	public ForecastingTotalItemUIAdapter clone(){
		ForecastingTotalItem obj = ModelFactory.of("").createForecastingTotalItem(getItem(), getPerCents());
