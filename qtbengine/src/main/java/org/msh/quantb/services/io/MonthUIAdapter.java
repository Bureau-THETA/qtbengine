...
public class MonthUIAdapter extends AbstractUIAdapter implements Comparable<MonthUIAdapter> {
	...
	public String toString(){
		...
		return DateUtils.formatDate(cal.getTime(), "MMM-yyyy");
	}
	...
	/**
	 * Create a month object from Joda LocalDate
	 * @param date
	 * @return
	 */
	public static MonthUIAdapter of(LocalDate date) {
		Month month = ModelFactory.of("").createMonth(date);
		MonthUIAdapter ret = new MonthUIAdapter(month);
		return ret;
	}
}
