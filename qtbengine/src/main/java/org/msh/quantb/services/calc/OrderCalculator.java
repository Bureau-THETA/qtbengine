...
public class OrderCalculator {
	...
	private void calcMedTotals() {
		...
		for(MedicineConsumption mC :getForecastCalculator().getMedicineConsumption()){
			...
			recalcQuantityAndCost(mC, medOrd);
			medOrd.setAdjustIt(fmu.getPackOrder(ModelFactory.of("")).getAdjust());
			medOrd.setAdjustItAccel(fmu.getPackOrder(ModelFactory.of("")).getAdjustAccel());
			medOrd.setPackPrice(fmu.getPackOrder(ModelFactory.of("")).getPackPrice());
			medOrd.setPackPriceAccel(fmu.getPackOrder(ModelFactory.of("")).getPackPriceAccel());
			medOrd.setPackSize(fmu.getPackOrder(ModelFactory.of("")).getPack());
			medOrd.setPackSizeAccel(fmu.getPackOrder(ModelFactory.of("")).getPackAccel());
			medOrd.setAdjustAccel(mC.getAccelDeliveriesTotal());
			medOrd.setAdjustedRegular(mC.getRegularDeliveriesTotal());
		}
