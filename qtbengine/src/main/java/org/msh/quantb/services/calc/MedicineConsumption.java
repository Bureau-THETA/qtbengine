...
/*			if (fr.getConsNew().compareTo(BigDecimal.ZERO) > 0 && tmp.getNewCases().compareTo(BigDecimal.ZERO) == 0){
	 ...
	 * @return
	 */
	public Long getAccelDeliveriesTotal() {
		Long ret = 0L;
	 ...
	 * @return
	 */
	public Long getRegularDeliveriesTotal() {
		Long ret = 0L;
		for(ConsumptionMonth cM : getRegularDeliveries()){
			ret = ret + cM.getDelivery().longValue();
		}
		return ret;
	}
	/**
	 ...
	 * @return
	 */
	public Long getAccelPacksTotal() {
		Long ret = 0L;
		for(ConsumptionMonth cM : getAccelDeliveries()){
			ret = ret + cM.getPacks().longValue();
		}
		return ret;
	}
	/**
	 ...
	 * @return
	 */
	public Long getRegularPacksTotal() {
		Long ret = 0L;
		for(ConsumptionMonth cM : getRegularDeliveries()){
			ret = ret + cM.getPacks().longValue();
		}
	 ...
	 * @return
	 */
	public Long getAccelNeedTotal() {
		Long ret = 0L;
		for(ConsumptionMonth cM : getAccelDeliveries()){
			ret = ret + cM.getIdealDelivery().longValue();
		}
		return ret;
	}
	 ...
	 * 2021-06-04 Replaced to getRegularDeliveriesTotal
	 * @return
	 */
	public Long getRegularNeedTotal() {
		/*		Long ret = 0L;
				for(ConsumptionMonth cM : getRegularDeliveries()){
					ret = ret + cM.getIdealDelivery().longValue();
				}
				//return ret;
		*/		
		return getRegularDeliveriesTotal();
	}
