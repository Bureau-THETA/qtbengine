...
public class ConsumptionMonth implements Comparable {
	...
	private BigDecimal p0Stock = BigDecimal.ZERO;
	
	// Sometimes, month consumption may require daily detailing
	private List<ConsumptionDetail> details = new ArrayList<ConsumptionDetail>();
	...
	public void setExpired(Long long1) {
		this.expired = long1;
	}



	public void setOrder(Long long1) {
		this.order = long1;
	}
	 ...
	 */
	public void addExpired(Long long1) {
		this.expired = expired + long1;
	}
	 ...
	 */
	public void addOrder(Long long1) {
		this.order = order + long1;
	}
	 ...
	 * @return
	 */
	public Long getOnHandInt() {
		return getOnHand().setScale(0, BigDecimal.ROUND_UP).longValueExact();
	}

	public Long getConsAllInt() {
		return getConsAll().setScale(0, BigDecimal.ROUND_UP).longValueExact();
	}
	...
	public Long getConsOldInt() {
		return getConsOld().setScale(0, BigDecimal.ROUND_UP).longValueExact();
	}

	public Long getConsNewInt() {
		return getConsNew().setScale(0, BigDecimal.ROUND_UP).longValueExact();
	}
	/**
	 * Expired in order batches
	 * @param long1
	 */
	public void addOrderExpired(Long long1) {
		this.orderExpired +=long1;
	...
	public void setP0Stock(BigDecimal stock) {
		this.p0Stock=stock;
	}
	
	

	public BigDecimal getP0Stock() {
		return p0Stock;
	}
	
	

	public List<ConsumptionDetail> getDetails() {
		return details;
	}

	public void setDetails(List<ConsumptionDetail> details) {
		this.details.clear();
	...
	public ConsumptionMonth getClone() {
		...
		ret.setDetails(this.getDetails());
		return ret;
	}
	/**
